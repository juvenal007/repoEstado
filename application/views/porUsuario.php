         ...
         <div class="card">
          ...
          <div class="card-body">
           <div class="tab-content p-0">
            ...
            <div class="form-group row">
             <label for="usuario" class="col-3 col-form-label">Rut usuario</label> 
             <div class="col-6">
              <div class="input-group">
               ...
               <input id="usuario" name="usuario" placeholder="Usuario" type="text" class="form-control" v-model='usuario'>
              </div>
             </div>
            </div> 
            <div class="form-group row">
             <div class="offset-3 col-6">
              <button @click="buscarPorUsuario(usuario)" name="enviar" type="submit" class="btn-lg btn-block btn-success">BUSCAR</button>
             </div>
            </div>
           </div>
...
<!--  <script src="https://unpkg.com/axios/dist/axios.min.js"></script>
  ...
  <script src="<?= base_url() ?>assets/js/porUsuario.js"></script>

           ...
           <div class="tab-content p-0">
            ...
            <div class="form-group row">
             <div class="offset-md-3 col-md-6 col-12">
              <button @click="terminarDocumento()"  name="enviar" type="submit" class="btn-lg btn-block btn-danger">TERMINAR</button>
             </div>
            </div>
...
$.widget.bridge('uibutton', $.ui.button);
  ...
  <script src="<?= base_url() ?>assets/js/terminarDocumento.js"></script>
  <script>

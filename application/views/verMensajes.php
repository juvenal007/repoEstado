             ...
             <div class="col-md-12">
              ...
              <div class="timeline">
               ...
               <div v-for="e in estadosFinales">
                <div class="mx-auto">
                 <button v-show="e.estado_nombre == 'ENVIADO'" class="btn btn-info"><strong>{{e.estado_nombre}}</strong></button>
                 <button v-show="e.estado_nombre == 'PROCESO'" class="btn btn-warning"><strong>{{e.estado_nombre}}</strong></button>
                ...
                <div class="timeline-item">
                 ...
                 <h3 class="timeline-header"><a href="#">{{e.idestado}} | {{e.usuario_nombre_pri}} {{e.usuario_apellido_pat}}</a>  Recibo documento: {{e.docu_nombre}}</h3>

                 ...
                 <table class="table table-hover table-striped">
                  ...
                  <tbody class="mx-auto">
                   <tr  v-for="doc in documentos">
                    ...
                    <td v-if="doc.docu_estado == 'ENVIADO'"><span class="right badge badge-warning"> {{doc.docu_estado}}</span></td>
                    <td v-if="doc.docu_estado == 'TERMINADO'"><span class="right badge badge-success"> {{doc.docu_estado}}</span></td>
                    ...
                    <td v-if="doc.docu_falta_dias >= 5 && doc.docu_estado == 'ENVIADO'"><span class="right badge badge-danger"> {{doc.docu_falta_dias}} Dias, {{doc.docu_falta_horas}} Horas, {{doc.docu_falta_minutos}} Minutos</span></td>
                    <td v-if="doc.docu_falta_dias > 1 && doc.docu_falta_dias < 5 && doc.docu_estado == 'ENVIADO'"><span class="right badge badge-warning"> {{doc.docu_falta_dias}} Dias, {{doc.docu_falta_horas}} Horas, {{doc.docu_falta_minutos}} Minutos</span></td>
                    <td v-if="doc.docu_falta_dias <= 1 && doc.docu_estado == 'ENVIADO'"><span class="right badge badge-info"> {{doc.docu_falta_dias}} Dias, {{doc.docu_falta_horas}} Horas, {{doc.docu_falta_minutos}} Minutos</span></td>
                    <td v-if="doc.docu_falta_dias >= 5 && doc.docu_estado == 'TERMINADO'"><span class="right badge badge-danger">FINALIZADO</span></td>
                    <td v-if="doc.docu_falta_dias > 1 && doc.docu_falta_dias < 5 && doc.docu_estado == 'TERMINADO'"><span class="right badge badge-warning">FINALIZADO</span></td>
                    <td v-if="doc.docu_falta_dias <= 1 && doc.docu_estado == 'TERMINADO'"><span class="right badge badge-info">FINALIZADO</span></td>
...
$.widget.bridge('uibutton', $.ui.button)
  ...
  <script src="<?= base_url() ?>assets/js/verDocumento.js"></script>

new Vue({
  el: 'main',
  data: {
    titulo: 'Buscar Documento por departamento',
...
//      window.open(archivoUrl);
    ...
    async buscarPorDepartamento(v) {

      var iddepartamento = v;

      var url = this.url + 'getDocumentoPorDepartamento';
      param = new FormData();

      param.append('departamento_iddepartamento', iddepartamento);
